...
class LoadCV2Images:  # for inference
    def __init__(self, cv2image, img_size=640):

        self.img_size = img_size
        self.image = cv2image
        self.mode = 'images'

        assert not(self.cv2 == None), 'No image found'
    ...
    def __next__(self):
        ...
        img = letterbox(self.image, new_shape=self.img_size)[0]
        ...
        return "", img, self.image, self.cap
